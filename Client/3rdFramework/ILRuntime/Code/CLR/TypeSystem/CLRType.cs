...
namespace ILRuntime.CLR.TypeSystem
{
    public unsafe class CLRType : IType
    {
        ...
        void InitializeBaseType()
        {
            ...
            if (baseType == null || baseType.TypeForCLR == typeof(Enum) || baseType.TypeForCLR == typeof(object) || baseType.TypeForCLR == typeof(ValueType) || baseType.TypeForCLR == typeof(System.Enum))
            {//都是这样，无所谓
                baseType = null;
            }
