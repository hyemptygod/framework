...
public class CoroutineManager : MonoBehaviour
{
    ...
    private static CoroutineManager[] ActiveInstances = new CoroutineManager[16];
    ...
    public static CoroutineManager Instance
    {
        get
        {
            ...
            {
                GameObject instanceHome = GameObject.Find("Coroutine Manager");

                if (instanceHome == null)
                {
                    instanceHome = new GameObject { name = "Coroutine Manager" };
    ...
    {
        return WaitUntilDone(RunCoroutine(coroutine));
    }
    ...
    public static float WaitUntilDone(AsyncOperation operation)
    {
        ...
        CoroutineManager inst = GetInstance(CurrentCoroutine.Key);
...
public static class MECExtensionMethods1
{
    ...
    {
        return CoroutineManager.RunCoroutine(coroutine);
    }
    ...
    {
        return CoroutineManager.RunCoroutine(coroutine, tag);
    }
    ...
    {
        return CoroutineManager.RunCoroutine(coroutine, segment);
    }
    ...
    {
        return CoroutineManager.RunCoroutine(coroutine, segment, tag);
    }
}
